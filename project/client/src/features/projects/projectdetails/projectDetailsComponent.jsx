...
const ProjectDetails = (props) => {
	...
	const listTickets = () => {
		return (
			<div className='border-rich-black border overflow-scroll min-h-[15rem] max-h-[15rem] 2xl:min-h-[20rem] 2xl:max-h-[20rem] bg-white'>
							...
							<div className='col-span-8 flex flex-row justify-between'>
								<div className='grid grid-cols-4 border min-h-[17rem] 2xl:min-h-[23rem] border-rich-black p-2 w-[49%]'>
									<div className='col-span-4 flex flex-col'>
										...
										<div className='text-xl pt-2 max-h-[17rem] 2xl:max-h-[23rem] overflow-scroll'>
